        ...
        column(
          ...
          fluidRow(
            ...
            div(
              ...
              div(style="display:inline-block;vertical-align:top;padding-bottom:4px;padding-right:7px;", actionButton('convert_next', 'Next', width = '100px')),
              div(
          ...
          fluidRow(
            div(style="display:inline-block;vertical-align:top;margin-top:10px;font-size:15px;margin-right:10px;margin-bottom:15px;", uiOutput('results_info')),
            div(
            ...
            div(
              ...
              div(
                style = 'display:flex;flex-direction:row;flex-wrap:wrap;gap:5px;',
                div(style="display:inline-block;vertical-align:top;margin-top:10px;margin-right:5px;padding-bottom:4px;", uiOutput('page_number_info')), 
                div(
                  style="display:inline-block;vertical-align:",
                  div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('previous_page', 'Previous', width = '90px')), 
                  div(
                    style="display:inline-block;vertical-align:",
                    div(style="display:inline-block;vertical-align:top;margin-bottom:-15px;padding-bottom:4px;", uiOutput('page_number_ui')),
                    div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('go', 'Search', width = '90px'))
                  ),
                  div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('next_page', 'Next', width = '90px'))   
                )
              )
            )
          ),
          ...
          fluidRow(
            ...
            div(style="display:inline-block;vertical-align:top;margin-top:10px;font-size:15px;margin-right:10px;margin-bottom:15px;", uiOutput('results_info2')),
            div(
              style="display:inline-block;vertical-align:top;font-size:15px;margin-right:10px;", 
              div(
                style='display:flex;flex-direction:row;flex-wrap:wrap;gap:5px;',
            ...
            div(
              ...
              div(
                style = 'display:flex;flex-direction:row;flex-wrap:wrap;gap:5px;',
                div(style="display:inline-block;vertical-align:top;margin-top:10px;margin-right:5px;padding-bottom:4px;", uiOutput('page_number_info2')), 
                div(
                  style="display:inline-block;vertical-align:",
                  div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('previous_page2', 'Previous', width = '90px')), 
                  div(
                    style="display:inline-block;vertical-align:",
                    div(style="display:inline-block;vertical-align:top;margin-bottom:-15px;padding-bottom:4px;", uiOutput('page_number_ui2')),
                    div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('go2', 'Search', width = '90px'))
                  ),
                  div(style="display:inline-block;vertical-align:top;padding-bottom:4px;", actionButton('next_page2', 'Next', width = '90px'))   
                )
              )
            )
          ),
